...
public class Update_Employee implements ActionListener {
    ...
    Update_Employee(String idaa){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("icon/add_emp3.jpg"));
        id15.setIcon(img);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee set emp_id='"+t1.getText()+"',name='"+t2.getText()+"',"
                        + "fname='"+t3.getText()+"',agr='"+age+"',dob='"+dat+"',address='"+t4.getText()+"',"
                        + "phone='"+t5.getText()+"',email='"+t6.getText()+"',education='"+t7.getText()+"'"
                        + ",post='"+t8.getText()+"',aadhar='"+t9.getText()+"' where emp_id='"+id_emp+"'";
